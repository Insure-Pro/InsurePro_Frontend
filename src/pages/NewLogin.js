    ...
    <div className="relative flex h-[100vh] w-full justify-center">
      ...
      <div className="login_mobile_img absolute   flex justify-center">
        <div class="relative flex flex-col items-center">
          ...
          <div
            class="relative top-[540px] flex h-[42px] w-[330px] cursor-pointer items-center justify-center rounded bg-white text-base font-semibold text-Primary-300 shadow-[0_0_16px_0_rgba(0,0,0,0.25)] hover:bg-Primary-300 hover:text-white"
            onClick={onStart}
          >
            INSUREPRO 이용하기
          </div>
